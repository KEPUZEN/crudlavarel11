...
<?php $__env->startSection('content'); ?>
    <div class="d-flex justify-content-center">
        <form class="form" action="<?php echo e(route('donaturs.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="card" id="card1">
                <span class="title">Informasi Donatur</span>
                <div class="group">
                    <input placeholder="" type="text" id="name" name="nama" value="<?php echo e(old('nama')); ?>" />
                ...
                <div class="group">
                    <textarea placeholder="" id="comment" name="pesan" rows="5" required spellcheck="false"><?php echo e(old('pesan')); ?></textarea>
                    <label for="comment">Pesan Donasi</label>
                    <?php if($errors->has('pesan')): ?>
                        <div class="error"><?php echo e($errors->first('pesan')); ?></div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="col-sm">
                        <div class="group">
                            <input placeholder="Rp. " type="text" id="dengan-rupiah" name="total_donasi"
                                value="<?php echo e(old('total_donasi')); ?>" required />
                            <?php if($errors->has('total_donasi')): ?>
                                <div class="error"><?php echo e($errors->first('total_donasi')); ?></div>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\website-donasi-laravel\resources\views/donaturs/create.blade.php ENDPATH**/ ?>